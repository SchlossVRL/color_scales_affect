...
plot_df$map_cscale<-factor(plot_df$map_cscale, levels=  c("DSB", "LSB", "DUB", "LUB", "DSG", "LSG", "DUG", "LUG", "DSR", "LSR", "DUR", "LUR", "DSY", "LSY", "DUY", "LUY"))
...
pheatmap(cormat_emotion_x_pc, display_numbers = T, fontsize = 20,number_color = 'white', treeheight_col = 0, treeheight_row = 0, color = cmap)
