...
p <- ggplot(ratings_trial_grouped, aes(x = hue, y = mean_rating, group = lightsat)) +
  geom_line(aes(colour = lightness,linetype = saturation),linewidth=.5) +
...
p
ggsave(paste0(plot_dir,'/exp1_facet_clustered_emotion_ratings.pdf'), dpi=300, height = 6, width=3.8,plot=p)
